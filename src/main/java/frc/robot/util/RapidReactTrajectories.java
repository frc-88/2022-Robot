...
public class RapidReactTrajectories
{
  ...
  public static Trajectory generateTwoBallTrajectory() {
    ...
    waypoints.add(new Pose2d(Units.feetToMeters(21.0D), Units.feetToMeters(3.0D), Rotation2d.fromDegrees(150.0D)));
  ...
  public static Trajectory generateFourBallTrajectory() {
    ...
    waypoints.add(new Pose2d(Units.feetToMeters(13.5D), Units.feetToMeters(7.0D), Rotation2d.fromDegrees(-175.0D)));
