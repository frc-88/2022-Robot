...
public class ClimberConstants {
    ...
    public static final ClimberState S_HIGH_LIFT_ONTO_HIGH_BAR = new ClimberState(0, 29.5, 28, 46);
    public static final ClimberState S_HIGH_TRANSITION_TO_HIGH_BAR = new ClimberState(-28, 33, 0, 43, true);
    ...
    public static final ClimberState S_TRAVERSAL_HIT_TRAVERSAL_BAR = new ClimberState(28, 55, 0, 29.5);
    public static final ClimberState S_TRAVERSAL_LIFT_ONTO_TRAVERSAL_BAR = new ClimberState(28, 46, 0, 29.5);
    public static final ClimberState S_TRAVERSAL_TRANSITION_TO_TRAVERSAL_BAR = new ClimberState(0, 43, -28, 33, true);
