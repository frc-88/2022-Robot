...
public class ClimberConstants {
    ...
    public static final ClimberState S_TRAVERSAL_REVERSE_RAISE_ABOVE_MID_BAR = new ClimberState(31, 41, 7.9, 44, 4, ClimberState.DEFAULT_TELESCOPE_TOLERANCE, false);
