...
public class DriveWithWaypointsPlan extends CommandBase {
  ...
  public DriveWithWaypointsPlan(Navigation nav, Drive drive, WaypointsPlan plan, long is_finished_timeout) {
    m_nav = nav;
    m_drive = drive;
    m_plan = plan;
  ...
  public DriveWithWaypointsPlan(Navigation nav, Drive drive, WaypointsPlan plan) {
